    ...
    <body class="body-inicio">
        ...
        <div class="contenedor-usuarios">
            <div class="encabezado-usuarios">
              <h1 class="titulo-bienvenida">Gestión de usuarios</h1>
              <div>
                ...
                <table class="tabla-usuarios">
                  <thead>
                    <tr>
                      ...
                      <th width="145" scope="col">Tipo de usuario</th>
                    ...
                    <?php
                     if ($resultado->num_rows > 0) {
                      while ($fila = $resultado->fetch_assoc()) {
                        ...
                        echo "<td>" . $fila['rol'] . "</td>";
                        echo "<td>
                          <a href='editar_usuario.php?id=" . $fila['ID_usuario'] . "' title='Editar'>📝</a> || 
                          <a href='eliminar_usuario.php?id=" . $fila['ID_usuario'] . "' onclick=\"return confirm('¿Estás seguro de eliminar este usuario?')\" title='Eliminar'>❌</a>
                        </td>";
                        echo "</tr>";
                      }
                    } else {
